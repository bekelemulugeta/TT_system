...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT branch_name, service_number, tt, wanip, lanip, tt_reg_date,tt_resolved_date, status, remark FROM `tt_registration` WHERE 1";
    $params = [];
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row['tt_resolved_date']) ?></td>
